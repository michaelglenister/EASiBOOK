<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProvisionalBookingCheck.aspx.cs" Inherits="Monkey_Business.ProvisionalBookingCheck" %>
    ...
    <div class="container text-center">
        <div class="well">
            ...
            <table class="confirmTable" style="margin-left:auto;margin-right:auto;">
                ...
                <tr><td colspan="2"><asp:Button ID="btnBack" runat="server" Text="Back to Provisional Bookings" CssClass="btn btn-info" Visible="false" OnClick="btnBack_Click" /></td></tr>
            </table>
        </div>
    </div>
</asp:Content>
