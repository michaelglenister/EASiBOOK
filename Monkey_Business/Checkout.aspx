<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="Monkey_Business.Checkout" %>
    ...
    <div class="container text-center">
        <div class="well">
            ...
            <table class="confirmTable" style="margin-left:auto;margin-right:auto;">
                ...
                <tr><td colspan="2"><asp:Button ID="btnBack" runat="server" Text="Back to Check-outs" CssClass="btn btn-info" Visible="false" OnClick="btnBack_Click" /></td></tr>
            </table>
        </div>
    </div>
</asp:Content>
