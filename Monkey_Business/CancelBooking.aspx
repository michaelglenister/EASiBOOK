<%@ Page Title="EASiBOOK :: Cancel Booking" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CancelBooking.aspx.cs" Inherits="Monkey_Business.CancelBooking" %>
    ...
    <div class="container text-center">
        <div class="well">
            ...
            <table class="confirmTable" style="margin-left:auto;margin-right:auto;">
                ...
                <tr><td colspan="2"><asp:Button ID="btnBack" runat="server" Text="Back to Booking History" CssClass="btn btn-info" Visible="false" OnClick="btnBack_Click" /></td></tr>
